...
const Feedback = () => (
  <section>
    ...
    className={`${styles.innerWidth} mx-auto flex flex-col my-10 lg:flex-row gap-6`}
    >
      <motion.div
      ...
      >
        ...
        <div>
          ...
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] text-white">Founder - Metaverses</p>
        </div>
