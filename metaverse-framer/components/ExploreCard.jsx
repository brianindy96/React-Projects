...
const ExploreCard = ({ key, index, active, handleClick, id, imgUrl, title}) => (
  <motion.div
  // by multiplying a delay with the index, each index will works on the specific delay
  variants={fadeIn('right', 'spring', index * 0.5, 0.875)}
  ...
  >
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        <div className={`${styles.flexCenter} w-[60px] rounded-[24px] mb-[16px]`}>
